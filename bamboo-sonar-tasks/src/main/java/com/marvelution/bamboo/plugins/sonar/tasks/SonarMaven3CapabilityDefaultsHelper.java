...
/**
 * Capability Defaults Helper for the Sonar Maven 3 task
 *  
 * @author <a href="mailto:markrekveld@marvelution.com">Mark Rekveld</a>
 *
 * @since 1.2.0
 */
public class SonarMaven3CapabilityDefaultsHelper extends AbstractHomeDirectoryCapabilityDefaultsHelper {
	...
	protected String getExecutableName() {
		return SonarMaven3Config.getExecutableName();
	}
	...
	protected String getCapabilityKey() {
		return "system.builder.mvn3.Maven 3";
	}
	...
	protected Predicate<File> getValidityPredicate() {
		return new MavenUtils.MavenVersionMatcher(MAVEN_VERSION_3);
	}
